...
import { isAmbientConditionStatement, isAmbiguousOrganizationRequest, isTimedTaskStatement } from "./taskIntent";
...
function classifyOrganizeAction(text: string): "record.organize" | "resource.organize" | null {
  if (isAmbiguousOrganizationRequest(text)) return null;
