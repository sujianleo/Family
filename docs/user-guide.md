...
本地免登录模式会直接进入家庭主页。这里的数据用于体验，不应混入真实家庭隐私。
...
- **iPhone / iPad**：使用 Safari 打开，选择“添加到主屏幕”；系统通知通常也要求先完成主屏幕安装。
- **Android / 桌面浏览器**：使用浏览器提供的“安装应用”入口。
...
配置公网域名、端口、本地地址和连接模式，并分别测试公网或局域网连接。

### AI

管理模型服务商、模型 ID、助手名称、个性与初始记忆。删除服务商前应确认是否仍有依赖该模型的后台功能。
